...
$(LIBSPARSE_C_OBJ_FILES): $(obj)/libsparse/%.o: $(src)/core/libsparse/%.c | dirs
	$(CC) $(CFLAGS) $(LIBSPARSE_CFLAGS) -c -o $@ $^

$(LIBSPARSE_CXX_OBJ_FILES): $(obj)/libsparse/%.o: $(src)/core/libsparse/%.cpp | dirs
...
$(SIMG2IMG_OBJ_FILES): $(obj)/simg2img/%.o: $(src)/core/libsparse/%.cpp | dirs
...
$(IMG2SIMG_OBJ_FILES): $(obj)/img2simg/%.o: $(src)/core/libsparse/%.cpp | dirs
...
$(APPEND2SIMG_OBJ_FILES): $(obj)/append2simg/%.o: $(src)/core/libsparse/%.cpp | dirs

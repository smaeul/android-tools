...
$(LIBCRYPTO_UTILS_C_OBJ_FILES): $(obj)/libcrypto_utils/%.o: $(src)/core/libcrypto_utils/%.c | dirs .core.patch.stamp
	$(CC) $(CFLAGS) $(LIBCRYPTO_UTILS_CFLAGS) -c -o $@ $^

$(LIBCRYPTO_UTILS_CXX_OBJ_FILES): $(obj)/libcrypto_utils/%.o: $(src)/core/libcrypto_utils/%.cpp | dirs
